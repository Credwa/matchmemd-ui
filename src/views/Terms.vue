<template>
  <LayoutDefault>
    <div>
      ...
      <p>Welcome to MatchMeMD!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of MatchMeMD's
        Website, located at https://app.matchmemd.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use MatchMeMD if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p>
        We employ the use of cookies. By accessing MatchMeMD, you agreed to use cookies in agreement
        with the MatchMeMD's
        <router-link class="text-pacific-500" to="/policy"> Privacy Policy. </router-link>
      </p>
      ...
      <p>
        Unless otherwise stated, MatchMeMD and/or its licensors own the intellectual property rights
        for all material on MatchMeMD. All intellectual property rights are reserved. You may access
        this from MatchMeMD for your own personal use subjected to restrictions set in these terms
        and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from MatchMeMD</li>
        <li>Sell, rent or sub-license material from MatchMeMD</li>
        <li>Reproduce, duplicate or copy material from MatchMeMD</li>
        <li>Redistribute content from MatchMeMD</li>
      </ul>
      ...
      <p>
        ...
        information in certain areas of the website. MatchMeMD does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of MatchMeMD,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, MatchMeMD shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </p>

      <p>
        MatchMeMD reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant MatchMeMD a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of MatchMeMD; and (d) the link is in the
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to MatchMeMD. Please include
      ...
      <p>
        No use of MatchMeMD's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
