interface Mixpanel {
   ...
   * this function disables tracking of unknown event. If passed an
   ...
   *
   * @param eventName The name of the event. This can be unknownthing the user does - 'Button Click', 'Sign Up', 'Item Purchased', etc.
   ...
   * from the function; unknown properties defined on this object
   ...
   * @param days How munknown days since the user's last visit to store the super properties
   */
   ...
   * @param days How munknown days since the users last visit to store the super properties
   */
  register_once(
    properties: { [index: string]: unknown },
    defaultValue?: string,
...
declare namespace Mixpanel {
  interface People {
     ...
     * @param callback If provided, the callback will be called after the tracking event
     */
    set_once(prop: string, value: unknown, callback?: () => void): void
    set_once(keys: { [index: string]: unknown }, callback?: () => void): void
     ...
     *     mixpanel.people.unset(['gender', 'Compunknown']);
     *
     ...
     * @param callback If provided, the callback will be called after the tracking event
     */
    union(prop: string, values: unknown, callback?: () => void): void
    union(keys: { [index: string]: unknown }, callback?: () => void): void
     ...
     * @param callback If provided, the callback will be called after the tracking event
     */
    append(prop: string, value: unknown, callback?: () => void): void
    append(keys: { [index: string]: unknown }, callback?: () => void): void
  ...
  interface Config {
     ...
     *
     * If set to 'localStorage', unknown existing mixpanel cookie
